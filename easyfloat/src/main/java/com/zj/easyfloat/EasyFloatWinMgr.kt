...
import com.zj.easyfloat.helpers.EasyFloatProxyWinMgr
import java.util.concurrent.atomic.AtomicBoolean

@SuppressLint("StaticFieldLeak")
class EasyFloatWinMgr : BaseEasyFloat<EasyFloatWinMgr>() {
    companion object {
        @JvmStatic
    ...
    private object INSTANCE {
        val holder = EasyFloatWinMgr()
    }

    ///////////////////////////////////////////////////////////////////////////////////

    @OptIn(OApiInit_ByLazy::class)
    private val _easyFloatProxyWinMgr by lazy { EasyFloatProxyWinMgr() }

    ///////////////////////////////////////////////////////////////////////////////////

    @OptIn(OApiInit_ByLazy::class)
    override fun getEasyFloatProxy(): BaseEasyFloatProxy {
        return _easyFloatProxyWinMgr
    }
}